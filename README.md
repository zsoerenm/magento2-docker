...
In **developer mode**, the Tailwind watcher starts automatically on container boot when Hyvä is detected — no manual steps needed. During **production builds**, Tailwind CSS is compiled automatically in the Docker build stage.
